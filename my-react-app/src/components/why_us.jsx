        ...
        <div class="grid gap-10 text-center lg:items-center">
          <div>
            ...
            <a href="#search"
              ...
              Mulai dari form cari <svg class="size-5 inline-flex items-center justify-center leading-none icon-shadcn" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg>
            </a>
          </div>
